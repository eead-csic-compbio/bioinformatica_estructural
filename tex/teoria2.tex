...
\begin{figure}
\begin{center} 
\includegraphics{foldit/standaloneFoldIt}
\caption%[]
{
...
\htmladdnormallink{https://fold.it/standalone}{https://fold.it/standalone} para Linux, MacOS y Windows. 
