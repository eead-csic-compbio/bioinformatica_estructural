\chapter{Estructura cuaternaria} \label{s4}

%\input{interface1.tex} %analisis de interfaces proteinas/dna/prot (SCWRL y dnaprot/aloy), explicar z-scores de dnaprot, bootstrap de matrices
...
\htmladdnormallink{SCWRL}{http://dunbrack.fccc.edu/lab/scwrl} \citep{Bower1997}   
...
Podemos aprovechar las observaciones de las figuras \ref{fig:prot2prot_cons} y \ref{fig:protdnacons}  
...
como vimos en la secci\'{o}n \ref{CM}, buscar directamente en el \htmladdnormallink{PDB}{https://www.rcsb.org/pdb}.
Sin embargo, en este caso iremos m\'{a}s r\'{a}pido si consultamos el repositorio 
\htmladdnormallink{3D-footprint}{https://floresta.eead.csic.es/3dfootprint} \citep{ContrerasMoreira2010}, 
...
desde el a\~no 2001 hay en marcha un experimento colectivo (\htmladdnormallink{CAPRI}{https://www.ebi.ac.uk/pdbe/complex-pred/capri}) 
